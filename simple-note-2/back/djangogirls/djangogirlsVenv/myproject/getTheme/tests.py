...
class GetThemeViewTests(APITestCase):
    ...
    @patch("db_modules.UserPersonalThemeData.check_all_theme_data")  # 模擬check_all_theme_data方法
    def test_post_valid_request(self, mock_check_all_theme_data, mock_check_username):
        ...
        response = self.client.post(self.url, json.dumps(data), content_type="application/json")  # 發送POST請求
