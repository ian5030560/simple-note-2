...
--
-- Table structure for table `user_subnote_data`
--

DROP TABLE IF EXISTS `user_subnote_data`;
...
--
-- Dumping data for table `user_subnote_data`
--

LOCK TABLES `user_subnote_data` WRITE;
/*!40000 ALTER TABLE `user_subnote_data` DISABLE KEYS */;
INSERT INTO `user_subnote_data` VALUES ('1','1','1'),('2','1','2');
