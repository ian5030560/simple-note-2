...
import { $getSelection, $isRangeSelection, LexicalCommand, createCommand, $createParagraphNode, $insertNodes, $getRoot, $isRootNode } from "lexical";
...
const ImageToTextModal = () => {
    ...
    return <Modal title="圖文辨識" open={open} footer={null} width={600}
        ...
        <Tabs defaultActiveKey="camera" items={items} onChange={(key) => setId(key)} />
    </Modal>
}
